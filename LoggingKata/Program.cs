...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Grab an IEnumerable of locations using the Select command: var locations = 
            //lines.Select(parser.Parse);
            ...
            // Include the Geolocation toolbox, so you can compare locations: `using 
            ...
            // If the distance is greater than the currently saved distance, update the 
            //distance and the two `ITrackable` variables you set above

            // Once you've looped through everything, you've found the two Taco Bells farthest 
            //away from each other.


            Console.WriteLine($"This TacoBell location is: {loc1.Name} This TacoBell location is: {loc2.Name}");
